            ...
            <section className="split-grid animate-fade-in delay-2" style={{marginBottom: '32px'}}>
              ...
              <div className="glass-card" style={{padding: '24px'}}>
                ...
                <div className="progress-container">
                  ...
                  <p style={{color: 'var(--text-muted)', fontSize: '0.85rem', marginTop: '6px'}}>Driven by brand loyalty and successful size matching.</p>
                </div>
                ...
                <div className="progress-container">
                  ...
                  <p style={{color: 'var(--text-muted)', fontSize: '0.85rem', marginTop: '6px'}}>Driven by wishlist hoarding and browsing intent.</p>
                </div>
                ...
                <div className="progress-container">
                  ...
                  <p style={{color: 'var(--text-muted)', fontSize: '0.85rem', marginTop: '6px'}}><strong>(52% driven by Fit & Fabric Uncertainty)</strong> and remaining by choice paralysis.</p>
                </div>
              </div>
